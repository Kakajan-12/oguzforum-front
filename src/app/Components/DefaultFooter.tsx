                ...
                <div className="container pt-20 pb-5 px-5 mx-auto">
                        ...
                        <div className="flex lg:w-2/5 flex-col items-center lg:items-start pt-10 lg:pt-0">
                            ...
                            <div className="w-full flex flex-col items-start">
                                ...
                                <div className="flex items-center mb-5">
                                    <PhoneEnabledIcon className="text-white mr-2" style={{ width: "30px", height: "30px" }} />
                                    <div className="text-white text-md lg:text-xl font-bolder">{phoneNumber}</div>
                                </div>
                                <div className="flex items-center mb-5">
                                    <MailOutlineIcon className="text-white mr-2" style={{ width: "30px", height: "30px" }} />
                    ...
                    <div className="flex lg:justify-between items-center gap-5 flex-col lg:flex-row">
                        <div className="text-center flex flex-wrap lg:w-1/2 items-center justify-center w-full lg:justify-start">
                            {whoWeAre.map((item, i) => (
                                <div key={item.id}>
                                    <Link className="text-slate-400 mb-4 lg:mb-0 text-[10px] md:text-sm mr-3" href={item.href}>
                                        {footerweAre[i]}
                                    </Link>
                                </div>
                            ))}
