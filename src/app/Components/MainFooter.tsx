                ...
                <div className="container pt-20 pb-5 px-5 mx-auto">
                    <div className="flex justify-between flex-col lg:flex-row mb-20">
                        <div className="flex lg:w-2/5 flex-col gap-8">
                            <p className="lg:text-4xl text-2xl blue-text font-bolder">
                                {t("footerfresh")}
                            </p>
                            ...
                            <div className="w-full hidden lg:flex  gap-3 items-center ">
                                <TelegramIcon className="text-white bg-mainBlue p-1" style={{
                                    borderRadius: "50%",
                                    width: "30px",
                                    height: "30px",
                                }}/>
                                <LinkedInIcon className="blue-text" style={{
                                    width: "35px",
                                    height: "35px",
                                }}/>
                                <InstagramIcon className="blue-text" style={{
                                    width: "35px",
                                    height: "35px",
                                }}/>
                                <WhatsAppIcon className="blue-text" style={{
                                    width: "35px",
                                    height: "35px",
                                }}/>
                            </div>
                        ...
                        <div className="flex lg:w-2/5 flex-col items-center lg:items-start pt-10 lg:pt-0">
                            ...
                            <div className="w-full flex flex-col items-start ">
                                <div className="flex items-center mb-5">
                                    ...
                                    <div className="blue-text text-md lg:text-xl font-bolder"><RichText
                                        htmlContent={address}/>
                                    </div>
                                </div>
                                <div className="flex items-center mb-5">
