...
const NewsFiltr:  React.FC<Props> = ({ onFilterChange }) => {
  ...
  return (
    <div className="container mx-auto ">
      <div className="pt-12 pb-7 md:pb-10 md:pt-32  px-2">
        ...
        <div className="flex justify-end gap-y-5 gap-x-5 mt-5 md:mt-10 md:px-0 w-full">
          <input
              value={title}
              onChange={(e) => setTitle(e.target.value)}
              className="border outline-none focus:border-mainBlue col-span-full md:col-span-1 border-slate-400 rounded-lg py-2 px-4 w-1/3"
              type="text"
              placeholder="Search"
          />
