  ...
  return (
    <div className="container mx-auto ">
      <div className="pt-12 pb-7 md:pb-10 md:pt-32  px-2">
        <h2 className="md:text-5xl md:px-5 text-xl font-bold text-mainBlue flex items-center"> <NavigationBackKnob/> Projects </h2>

        <div className="grid grid-cols-3 md:grid-cols-5 md:gap-x-5 gap-y-5 gap-x-5 mt-5 md:mt-10 md:px-0">
