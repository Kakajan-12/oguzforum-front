            ...
            <div className="flex flex-col divide-y-2 divide-[#002A5F] sm:divide-y-0">
              <div className="flex flex-wrap sm:justify-center flex-col sm:flex-row sm:space-y-4">
                {[
                  ...
                  <div
                    key={index}
                    className={`flex justify-between sm:justify-center items-center py-2 mt-4 sm:w-1/3 xl:w-1/5
                                        ${
                                          index % 3 !== 0
                                            ? "sm:border-l-2 sm:border-[#002A5F]"
                                            : ""
                                        }

                                        ${
                                          index !== 0
                                            ? "xl:border-l-2 xl:border-[#002A5F]"
                                            : ""
                                        }
                                        `}
                  >
                ...
                <div>
                  ...
                  <div className="flex flex-wrap gap-2 mt-2">
                    {event.organizers?.map((org) => {
                      const logoUrl = resolveMediaUrl(org.organizer_logo);
