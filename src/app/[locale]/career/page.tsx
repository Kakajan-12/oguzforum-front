...
export default function CareerRedirectPage() {
    ...
    const handleFileChange = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            setPhoto(file);
            setPhotoPreview(URL.createObjectURL(file)); // для превью
        }
    };
    ...
    const handleFileChangeCv = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        if (file) {
            setExperience(file);
            setCvPreview(URL.createObjectURL(file)); // для превью
        };
    };
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        // formData.append('experience', experience);      // File object
                    ...
                    <form onSubmit={handleSubmit} className="flex flex-col gap-10 md:gap-20">
                        ...
                        <div className="flex flex-col">
                            <div className="flex justify-between gap-3 items-end md:items-center">
                                ...
                                <div className="flex items-end cursor-pointer">
                                    ...
                                    <div className="text-mainBlue font-semibold text-xs md:text-sm lg:text-lg xl:text-xl" onClick={clearPersonal}>{t('clear')}</div>
                                </div>
                            </div>
                            ...
                            <div className="grid gap-y-5 px-5 md:px-10 mt-7 md:mt-10 gap-x-10 grid-cols-1">
                                ...
                                <label
                                    ...
                                    <p className="text-mainBlue text-xs">{t('uploadText')}</p>
                        ...
                        <div className="flex flex-col mt-5">
                            <div className="flex justify-between items-end">
                                ...
                                <RiDeleteBin5Line
                                        className="w-4 h-4 md:w-5 md:h-5 lg:h-7 lg:w-7 mb-[1px] mr-2 text-mainBlue"/>
                                    <div className="text-mainBlue font-semibold text-xs md:text-sm lg:text-lg xl:text-xl" onClick={clearProfile}>{t('clear')}</div>
                                </div>
                            </div>
                                            ...
                                            <motion.div initial={{height: 0}} animate={{height: 'auto'}}
                                                ...
                                                <div className="py-10 flex flex-col gap-10">
                                                    <label
                                                        ...
                                                        <p className="text-mainBlue text-xs">{t('uploadText')}</p>
                                                        <input ref={cvInputRef} type="file" onChange={handleFileChangeCv} hidden/>
                                                        {experience && (
                                                            <div className="flex flex-col items-center text-mainBlue mt-4 text-sm">
                                                                {/* Отображение превью, если это изображение */}
