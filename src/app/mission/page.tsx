...
export const metadata = {
  title: "Mission — Coming soon | Oguz Forum",
};

export default function MissionComingSoon() {
  return (
    <section className="flex min-h-[70vh] items-center justify-center bg-white px-4 pt-24 pb-16">
      <div className="max-w-xl text-center">
        ...
        <p className="mt-4 text-base leading-relaxed text-gray-500">
          We&apos;re preparing our Mission page — the vision and values behind
          OGUZ Forum. Check back soon.
        </p>
