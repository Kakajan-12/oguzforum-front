            ...
            <>
                <div className="fixed bottom-6 right-6 z-50">
                    <button
                        ...
                        className="relative flex h-14 w-14 items-center justify-center rounded-full bg-[#1268B3] text-white shadow-lg shadow-[#1268B3]/30 transition-transform hover:scale-105"
                    >
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="mt-0.5 flex items-center gap-1.5 text-xs text-white/80">
                                <span className={`h-2 w-2 rounded-full ${isWorkingHours ? "bg-green-400" : "bg-yellow-400"}`} />
