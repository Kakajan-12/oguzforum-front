...
export default function ChatWidget() {
  ...
  return (
    <>
      <div className="fixed bottom-6 right-6 z-[999] flex w-[22rem] max-w-[calc(100vw-2rem)] flex-col overflow-hidden rounded bg-white shadow-2xl ring-1 ring-black/5">
        {/* Header */}
