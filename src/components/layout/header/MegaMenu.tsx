                  ...
                  <div>
                    ...
                    {phones.map((p, i) => (
                      <a
                        ...
                        className={`block text-sm text-white hover:text-white/80 ${i === 0 ? "mt-3" : "mt-2"}`}
                      >
                        {p}
                      </a>
                    ))}
                    {emails.map((m, i) => (
                      <a
                        key={`mail-${i}`}
                        href={`mailto:${m}`}
                        className="block mt-2 text-sm text-white hover:text-white/80"
                      >
                        {m}
                      </a>
                    ))}
                  ...
                  {group.links.map((link) => (
                    <li key={link.label + link.href}>
                      <Link
                        ...
                        prefetch={false}
                        onClick={onNavigate}
                        className="group flex items-center gap-2.5 text-sm text-white hover:text-white/80"
                      >
                        <Image
                          src="/assets/link.svg"
                          width={12}
